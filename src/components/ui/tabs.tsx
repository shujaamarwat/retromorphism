...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-2xl bg-white-100 p-1 text-muted-foreground border-2 border-[#001428] shadow-[-2px_4px_0px_#001428]",
      className
    )}
    {...props}
  />
